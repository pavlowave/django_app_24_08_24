...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('price', models.DecimalField(decimal_places=2, max_digits=6)),
                ('id', models.CharField(default=uuid.UUID('f351c526-01fb-4233-938f-2f9b1e84aae3'), max_length=128, primary_key=True, serialize=False)),
                ('country', models.CharField(choices=[('bel', 'Беларусь'), ('rus', 'Россия')], max_length=128)),
            ],
            options={
                'abstract': False,
            },
